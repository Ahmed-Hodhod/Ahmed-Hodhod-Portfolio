    ...
    >
      <div className="flex justify-center">
        <div className=" w-full px-10 sm:w-[600px] md:w-[700px] lg:w-[800px] xl:w-[1000px] 2xl:w-[1200px] py-4 flex justify-between relative">
          <div
            onClick={() => {
              window.open("https://www.linkedin.com/in/ahmed-abdelsalam-hodhod/");
              ReactGA.event({
                category: "Button.Click",
                action: "@hodhod linkedin",
              });
            }}
          ...
          >
            ...
            <div
              onClick={() => {
                ...
                window.open("https://github.com/Ahmed-Hodhod");
              }}
            ...
            <div
              onClick={() => {
                ...
                window.open("mailto:ahmed.abdelsalam.sa@gmail.com");
              }}
              data-cursor={true}
